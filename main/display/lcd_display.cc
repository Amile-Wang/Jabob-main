...
//     lv_obj_set_style_text_font(screen, fonts_.text_font, 0);
//     lv_obj_set_style_text_color(screen, current_theme_.text, 0);
//     //lv_obj_set_style_bg_opa(screen, LV_OPA_TRANSP, 0); // 设置背景为透明
//     lv_obj_set_style_bg_color(screen, current_theme_.background, 0);
...
//     lv_obj_set_size(status_bar_, LV_VER_RES, fonts_.text_font->line_height);
//     lv_obj_set_style_radius(status_bar_, 0, 0);
...
//     lv_obj_set_style_bg_color(content_, lv_color_hex(0xff0000), 0);
...
//     lv_obj_set_style_text_font(emotion_label_, &font_awesome_30_4, 0);
//     lv_obj_set_style_text_color(emotion_label_, current_theme_.text, 0);
//     //lv_obj_set_size(emotion_label_, 280,240); // 设置宽高像素
//     //lv_obj_set_align(emotion_label_, LV_ALIGN_CENTER); // 明确设置对齐方式
//     //lv_obj_set_style_bg_color(emotion_label_, lv_color_hex(0xff0000), 0);
//     lv_obj_set_style_bg_opa(emotion_label_, LV_OPA_30, 0);
    // lv_label_set_text(emotion_label_, FONT_AWESOME_AI_CHIP);
//     lv_obj_align_to(emotion_label_, screen, LV_ALIGN_TOP_LEFT,0,-40);

//     chat_message_label_ = lv_label_create(screen);
//     lv_label_set_text(chat_message_label_, "");
//     lv_obj_set_width(chat_message_label_, LV_VER_RES * 0.9); // 限制宽度为屏幕宽度的 90%
//     lv_label_set_long_mode(chat_message_label_, LV_LABEL_LONG_WRAP); // 设置为自动换行模式
//     lv_obj_set_style_text_align(chat_message_label_, LV_TEXT_ALIGN_CENTER, 0); // 设置文本居中对齐
//     lv_obj_set_style_text_color(chat_message_label_, current_theme_.text, 0);
//     // 绝对定位：距离屏幕底部两行
//     //int32_t y_pos = LV_VER_RES - (2 * fonts_.text_font->line_height);
//     lv_obj_align_to(chat_message_label_, screen, LV_ALIGN_TOP_MID, 0,20);
//     lv_obj_move_foreground(chat_message_label_); // 关键设置：置顶显示
...
// #endif
    ...
    lv_obj_set_style_text_color(emotion_label_, current_theme_.text, 0);
    lv_label_set_text(emotion_label_, "😎");
    lv_obj_align(emotion_label_, LV_ALIGN_BOTTOM_LEFT, 0, 0); // 居中对齐
    lv_obj_move_background(emotion_label_); // 移动到背景层
    lv_obj_set_style_bg_color(emotion_label_, lv_color_hex(0xff0000), 0);
   ...
   // lv_obj_set_style_bg_opa(emotion_label_, LV_OPA_TRANSP, 0); // 背景透明
    ...
    // lv_label_set_text(chat_message_label_, "");
    // // lv_obj_set_width(chat_message_label_, LV_HOR_RES * 0.01); // 限制宽度为屏幕宽度的 90%
    // lv_obj_set_size(preview_image_, width_ * 0.01, height_ * 0.01);
    // lv_label_set_long_mode(chat_message_label_, LV_LABEL_LONG_WRAP); // 设置为自动换行模式
    // lv_obj_set_style_text_align(chat_message_label_, LV_TEXT_ALIGN_CENTER, 0); // 设置文本居中对齐
    // lv_obj_set_style_text_color(chat_message_label_, current_theme_.text, 0);
