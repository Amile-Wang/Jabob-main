...
**当前版本**: `2.2.0`
**首要目标**: 保证会议搭子模式可持续转录、可通过唤醒词临时提问，并能可靠退出和恢复普通对话。
**当前推荐板型**: `bread-compact-wifi-lcd-tianhao-uac`

**[📖 2.0.5 历史发布说明](docs/v2.0.5-release-notes.md)**
...
- **推荐bsp**: bread-compact-wifi-lcd-tianhao-uac
